  ...
  return (
    <>
      <div className="whatwedo">
        ...
        <h2 className="second">
          Feldmans Advocacy Group is a company that provides comprehensive
          digital and communications assistance to political campaigns,
          non-profit entities, and advocacy groups.
        </h2>
        <h2 className="second">
